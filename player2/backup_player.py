...
THE_DATA = PyML.VectorDataSet('training-9k.txt', labelsColumn = -1)
THE_DATA_TWO = PyML.VectorDataSet('test-1k.txt', labelsColumn = -1)
...
THE_SVM_THREE.load('the_svm_five', THE_DATA)
THE_SVM_FOUR.load('the_svm_six', THE_DATA)
THE_SVM_FIVE.load('the_svm_seven', THE_DATA_TWO)
THE_SVM_SIX.load('the_svm_eight', THE_DATA)
THE_SVM_SEVEN.load('the_svm_nine', THE_DATA)
THE_SVM_EIGHT.load('the_svm_ten', THE_DATA)
THE_SVM_TWO.load('the_svm_four', THE_DATA)
THE_SVM.load('the_svm_two', THE_DATA)
